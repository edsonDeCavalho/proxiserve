...
import com.proxiserve.proximobilite.core.utils.SslUtils
...
//app/src/main/java/com/proxiserve/proximobilite/modules/detail_intervention/features/historique/domain/use_cases/InsertAllHistoriques.kt
...
import com.proxiserve.proximobilite.modules.intervention.data.repository.CertificatInterventionRepositoryImpl
...
import com.proxiserve.proximobilite.modules.intervention.data.repository.PhotoRepositoryImpl
import com.proxiserve.proximobilite.modules.intervention.domain.repository.PhotoRepository
import com.proxiserve.proximobilite.modules.intervention.domain.use_case.DeletePhoto
import com.proxiserve.proximobilite.modules.intervention.domain.use_case.GetAllPhotos
import com.proxiserve.proximobilite.modules.intervention.domain.use_case.GetPhotoById
import com.proxiserve.proximobilite.modules.intervention.domain.use_case.GetPhotoFromCertificatIntervention
import com.proxiserve.proximobilite.modules.intervention.domain.use_case.InserPhoto
import com.proxiserve.proximobilite.modules.intervention.domain.use_case.PhotoUseCases
import com.proxiserve.proximobilite.modules.intervention.domain.use_case.UpdatePhoto
...
object AppModule {
    ...
    fun provideFeuilleDeRouteDatabase(app: Application): FeuilleDeRouteDatabase {
        return Room.databaseBuilder(
            ...
            FeuilleDeRouteDatabase.DATABASE_NAME
        ).build()
    }
...
//            .baseUrl("http://10.100.128.148:3001/")
//            .baseUrl("http://192.168.0.38:3001/")
            .baseUrl("https://proximobiliterec.proxiserve.fr/")
//            .baseUrl("https://api-mobilite.ppr.azure.reseau.pxs/")
            .client(SslUtils.getUnsafeOkHttpClient().build())
//            .client(client.build())
    ...
    @Provides
    @Singleton
    fun provideCertificatInterventionRepository(
        db: FeuilleDeRouteDatabase,
    ): CertificatInterventionRepository {
        return CertificatInterventionRepositoryImpl(db.certificatInterventionDao)
    }
    ...
    fun providePhotoRepository(
        ...
        return PhotoRepositoryImpl(db.photoDao)
    }
    ...
    @Provides
    @Singleton
    fun provideCertificatInterventionUsesCases(
        @ApplicationContext context: Context,
        repository: CertificatInterventionRepository
    ...
    @Singleton
        ...
        return PhotoUseCases(
            ...
            getPhotById= GetPhotoById(repository),
            getPhotoFromCertificatIntervention= GetPhotoFromCertificatIntervention(repository),
            insertPhoto= InserPhoto(repository),
            updatePhoto= UpdatePhoto(repository),
        )
    }
